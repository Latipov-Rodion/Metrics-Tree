...
window.I18N_UI = {
  en: {
    ...
    'about.feat_thresholds': '<strong>Industry benchmarks</strong> for 36 metrics (SaaS / E-commerce / Mobile / Media / universal).',
    'about.feat_goal': '<strong>🎯 Goal mode</strong> — reverse calculations for 16 metrics (~32 scenarios): "I want LTV:CAC=3 — what is the max CAC?"',
    ...
    'about.feat_urls': '<strong>🔗 Clean URLs</strong> — 44 pages with unique meta and JSON-LD.',
  ...
  uz: {
    ...
    'about.feat_thresholds': '<strong>Soha bencharklari</strong> 36 ta metrika uchun (SaaS / E-tijorat / Mobil / Media / universal).',
    'about.feat_goal': '<strong>🎯 Maqsad rejimi</strong> — 16 ta metrika uchun teskari hisob (~32 ta stsenariy): "LTV:CAC=3 kerak — maksimal CAC qancha?"',
    ...
    'about.feat_urls': '<strong>🔗 Toza URL’lar</strong> — noyob meta va JSON-LD bilan 44 ta sahifa.',
