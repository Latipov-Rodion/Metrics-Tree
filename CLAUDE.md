...
**MetricTree** (metricstree.vercel.app) is a free online calculator for ~52 product
...
```
index.html              ← THE app. HTML+CSS+JS+52 metric defs+i18n, all inline. Source of truth.
